...
// 🔴 ĐÃ SỬA: LOẠI BỎ KHỚP THEO TÊN (TUYỆT ĐỐI THEO MÃ)
...
// 🔴 ĐÃ SỬA: CHỈ KIỂM TRA MÀU DỰA TRÊN MÃ KỸ THUẬT
        ...
        if (currentTabType === 'DTNH') {
            ...
            pageData.forEach(function (item, index) {
                ...
                if (currentTab === 'ICD10' || currentTabType === 'PHAC_DO') {
                    ...
                    // 🔴 SỬA LẠI: CHỈ TRUYỀN MÃ HIỂN THỊ ĐỂ KIỂM TRA MÀU
                    ...
                    // 🔴 SỬA LẠI: CHỈ LẤY THÔNG TIN THEO MÃ, KHÔNG THEO TÊN NỮA
                    arrSearch.forEach(m => {
                    ...
                    // CHỈ GIỮ LẠI KHỚP TÊN CHO VIỆC TÌM TRONG GIỎ HÀNG (vì có những kĩ thuật khoa đăng ký theo tên chưa mã)
